...
In its current form, these tools are still experimental and subject to ongoing development. Future work will entail increasing stability as well as adding comprehensive documentation. Once it is complete, I plan to present it at a conference and continue to use it to make music.
